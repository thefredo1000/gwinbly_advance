...
namespace
{
    ...
    void sprite_scene(bn::sprite_text_generator &text_generator)
    {
        bn::music_items::erotic.play(0.5);
        bn::sprite_ptr gwimbly_sprite = bn::sprite_items::gwimbly.create_sprite(0, 0);
        constexpr bn::string_view info_text_lines[] = {
            "START: go to next scene",
        };

        common::info info("Sprite", info_text_lines, text_generator);
        ...
        while (!bn::keypad::start_pressed())
        {
            ...
            if (bn::keypad::right_held())
            {
                ...
                gwimbly_sprite.set_position(gwimbly_sprite.x() + 1, 0);
            }
